...
public class Task {
    public static void main(String[] args) {
        ...
        Notebook nb3 = new Notebook("Lenovo", "ThinkPad E14 Gen 2", 8, 256, "Windows 10", "черный");
        Notebook nb4 = new Notebook("Apple", "MacBook Pro", 32, 512, "macOS", "серебристый");
        Notebook nb5 = new Notebook("Asus", "VivoBook Pro 14 K3400PA-KP109", 16, 512, "Windows 10", "серебристый");
        Notebook nb6 = new Notebook("Huawei", "MateBook D16 RLEF-X", 16, 512, "Windows 10", "серый");
        Notebook nb7 = new Notebook("Asus", "ROG Zephyrus G14 GA402RJ-L4045", 8, 1000, "Без ОС", "серый");
        Notebook nb8 = new Notebook("MSI", "Raider GE78 HX 13VH-094RU", 32, 2000, "Windows 11", "черный");
        Notebook nb9 = new Notebook("Apple", "MacBook Air", 8, 256, "macOS", "серый");
        Notebook nb10 = new Notebook("Acer", "Aspire 7 A715-42G-R427", 16, 512, "Windows 11", "черный");
    ...
    // Вызов списка функций программы
    public static void Show123450(){
    ...
    public static void filterRAM(HashSet<Notebook> notebooks, Scanner scanner) {
        ...
        if (ram.contains(filter)) {
            System.out.println();
            System.out.println("Отобрали подходящие модели по вашему запросу: ");
            System.out.println();
            for (Notebook note : notebooks) {
    ...
    // Фильтр по объему жесткого диска
